...
struct IndirectDrawCommand
{
     ...
     * @note Vulkan/DX 스펙상 음수 시프팅이 가능해야 하므로 반드시 i32 타입이어야 합니다.
     */
    i32 vertex_offset;
...
struct DrawCommand
{
    ...
    static constexpr u16 INVALID_MATERIAL_SLOT = std::numeric_limits<u16>::max();
    ...
    u32 entity_id = Entity::INVALID_ID;
     ...
     */
    u16 material_slot_index = INVALID_MATERIAL_SLOT;
