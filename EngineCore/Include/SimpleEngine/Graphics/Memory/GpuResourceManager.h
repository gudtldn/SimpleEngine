...
public:
     ...
     */
    [[nodiscard]] Optional<const MeshResidencyKey&> GetMeshResidencyKey(const AssetId& in_id) const;
     ...
     */
    void SetMeshResidencyKey(const AssetId& in_id, MeshResidencyKey in_key);

    /**
     * 메시의 Residency Key를 제거합니다. UnloadMesh 호출 시 함께 호출하세요.
     * @param in_id Asset ID
     */
    void RemoveMeshResidencyKey(const AssetId& in_id);
...
private:
    ...
    HashMap<AssetId, MeshResidencyKey> mesh_residency_keys;
