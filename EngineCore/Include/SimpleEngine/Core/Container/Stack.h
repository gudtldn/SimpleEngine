...
{
/**
 * LIFO(Last-In, First-Out) 정책을 따르는 컨테이너 어댑터
...
public:
    Stack() = default;
    explicit Stack(const ContainerType& cont);
    explicit Stack(ContainerType&& cont);
...
public:
    ...
    /** Stack의 맨 위에서 요소를 제거하고, 그 값을 Optional로 반환합니다. */
