 ...
 * @tparam BufferSize
 */
template <usize BufferSize = std::dynamic_extent>
...
template <usize BufferSize>
FrameMemoryResource<BufferSize>::FrameMemoryResource(usize buffer_size, memory_resource* upstream) requires (BufferSize == std::dynamic_extent)
...
template <usize BufferSize>
void* FrameMemoryResource<BufferSize>::do_allocate(usize size, usize align)
{
    return monotonic_resource.allocate(size, align);
}

template <usize BufferSize>
void FrameMemoryResource<BufferSize>::do_deallocate(void* ptr, usize size, usize align)
{
