 ...
 */
struct SE_CORE_API SE_ANNOTATION(=meta::Reflect, =meta::Transient, =meta::Component) GlobalTransformComponent
{
...
SE_DECLARE_REFLECTION_V1(se::GlobalTransformComponent)
