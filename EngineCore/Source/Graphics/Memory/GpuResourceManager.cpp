...
namespace
{
SDL_GPUTextureFormat ToSDLFormat(ETextureFormat fmt)
{
    switch (fmt)
    {
    ...
    case ETextureFormat::BC1_UNORM:           return SDL_GPU_TEXTUREFORMAT_BC1_RGBA_UNORM;
    case ETextureFormat::BC1_UNORM_SRGB:      return SDL_GPU_TEXTUREFORMAT_BC1_RGBA_UNORM_SRGB;
    case ETextureFormat::BC3_UNORM:           return SDL_GPU_TEXTUREFORMAT_BC3_RGBA_UNORM;
    case ETextureFormat::BC3_UNORM_SRGB:      return SDL_GPU_TEXTUREFORMAT_BC3_RGBA_UNORM_SRGB;
    case ETextureFormat::BC4_UNORM:           return SDL_GPU_TEXTUREFORMAT_BC4_R_UNORM;
    case ETextureFormat::BC5_UNORM:           return SDL_GPU_TEXTUREFORMAT_BC5_RG_UNORM;
    case ETextureFormat::BC7_UNORM:           return SDL_GPU_TEXTUREFORMAT_BC7_RGBA_UNORM;
    case ETextureFormat::BC7_UNORM_SRGB:      return SDL_GPU_TEXTUREFORMAT_BC7_RGBA_UNORM_SRGB;
...
Optional<const GpuResourceManager::MeshResidencyKey&> GpuResourceManager::GetMeshResidencyKey(const AssetId& in_id) const
{
    return mesh_residency_keys.Find(in_id);
}

void GpuResourceManager::SetMeshResidencyKey(const AssetId& in_id, MeshResidencyKey in_key)
{
    mesh_residency_keys.Insert(in_id, std::move(in_key));
}

void GpuResourceManager::RemoveMeshResidencyKey(const AssetId& in_id)
{
    mesh_residency_keys.Remove(in_id);
}
...
)
{
    ...
    const bool compressed = IsCompressed(in_texture.format);
